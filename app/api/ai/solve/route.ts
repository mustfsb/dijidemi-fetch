...
export async function POST(request: NextRequest) {
    try {
        ...
        if (fetchCookies.includes('TEST_TOKEN')) {
             return NextResponse.json({
                success: true,
                imageUrl: 'https://placehold.co/600x400/png?text=Test+Question+Image', 
                solution: "Bu bir demo hesabıdır. Gerçek soru çözümü için geçerli Dijidemi hesabı ile giriş yapmalısınız.\n\nAncak, örnek çözüm:\n1. Sorudaki veriler incelenir.\n2. Formül uygulanır: $F = m \\cdot a$\n3. Sonuç bulunur."
            });
        }
        // -----------------------------
