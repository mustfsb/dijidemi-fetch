...
import { Moon, Sun, ArrowLeft, Settings, LogIn, BookOpen, ClipboardList, ChevronRight, ChevronLeft, Calendar, Upload, Loader2, CheckCircle2, Circle } from 'lucide-react';
...
type ActiveTab = 'books' | 'assignments' | 'test-view' | 'program';
