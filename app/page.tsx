    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="main">
        ...
        {activeTab === "assignments" && !testRunner.selectedTest && (
          <div>
            <h1 className="section-title">Odevlerim</h1>
            {(assignments.loading || testRunner.loading) && (
              <div className="flex items-center gap-3 py-8 text-zinc-500 font-mono text-sm">
                <Loader2 className="w-4 h-4 text-red-600 animate-spin" />
                {testRunner.loading ? testRunner.loadingText : assignments.loadingText}
              </div>
            )}
            {assignments.assignments.length > 0 ? (
              ...
              !assignments.loading && !testRunner.loading && (
                <p className="empty-msg">Aktif odev bulunamadi.</p>
              )
            )}
          </div>
        )}
              ...
              <div className="split-layout">
                ...
                {testRunner.data && (
                  <div className="panel">
                    ...
                    {testRunner.data.CevapAnahtari && testRunner.data.CevapAnahtari.length > 0 ? (
                      ...
                      <div className="p-4 text-sm text-zinc-500 border border-zinc-800 rounded-lg bg-zinc-900/30">
                        Bu test için cevap anahtarı bulunamadı.
                      </div>
                    )}
